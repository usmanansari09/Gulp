...
if os.name == 'nt':
    import platform
    OSGEO4W = r"C:\Program Files\QGIS 3.20.2"
    assert os.path.isdir(OSGEO4W), "Directory does not exist: " + OSGEO4W
    os.environ['OSGEO4W_ROOT'] = OSGEO4W
    os.environ['GDAL_DATA'] = OSGEO4W + r"\share\gdal"
    os.environ['PROJ_LIB'] = OSGEO4W + r"\share\proj"
    os.environ['PATH'] = OSGEO4W + r"\bin;" + os.environ['PATH']
GDAL_LIBRARY_PATH = r'C:\Program Files\QGIS 3.20.2\bin\gdal302.dll'
...
INSTALLED_APPS += LOCAL_APPS + THIRD_PARTY_APPS + ["modules"]
...
TWILLIO_FROM_NUMBER = env.str("TWILLIO_FROM_NUMBER", "+17745003158")
